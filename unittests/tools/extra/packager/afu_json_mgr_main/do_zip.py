...
z.write('/home/workspace/jelonanx/opae-sdk/unittests/tools/extra/packager/afu_json_mgr_main/__main__.py', '__main__.py')
z.close()

# Write out the buffer
with open('/home/workspace/jelonanx/opae-sdk/unittests/bin/afu_json_mgr', 'wb') as f:
