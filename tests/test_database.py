...
def test_get_type_from_enum():
    ...
    init_signature_max_size = mock.MagicMock(return_value=64)
    init_supported_cancels = mock.MagicMock()
    init_cert_types = mock.MagicMock()
    FAMILY_DATABASE_test = FAMILY_DATABASE(init_family, init_supported_types, init_max_csk, init_signature_max_size.return_value, init_supported_cancels, init_cert_types)
