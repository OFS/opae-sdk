...
{
    EXPECT_NE(FPGA_OK, fpgaPropertiesGetDeviceID(NULL, NULL));
}
 ...
 * @details Given a non-null fpga_properties* object<br>
 *          And its object type is FPGA_DEVICE
 ...
 * @brief   Tests: fpgaPropertiesGetAcceleratorState
 * @details Given a null fpga_properties* object<br>
 *          When I call fpgaPropertiesGetAcceleratorState with the null object<br>
 *          Then the return value is FPGA_INVALID_PARAM<br>
 * */
 ...
 * @brief   Tests: fpgaPropertiesGetAcceleratorState
 * @details Given a non-null fpga_properties* object<br>
 *          When I call fpgaPropertiesGetAcceleratorState with a null state pointer<br>
 *          Then the return value is FPGA_INVALID_PARAM<br>
 * */
 ...
 * @brief   Tests: fpgaPropertiesSetAcceleratorState
 * @details Given a null fpga_properties* object<br>
 *          When I call fpgaPropertiesSetAcceleratorState with the null object<br>
 *          Then the result is FPGA_INVALID_PARAM<br>
 */
TEST( Properties, cliff_nodrv_prop_179)
{
    fpga_properties prop = NULL;
    // Call the API to set the state on the property
    fpga_result result = fpgaPropertiesSetAcceleratorState(prop, FPGA_ACCELERATOR_UNASSIGNED);
...
/**
 * @test    cliff_nodrv_prop_214
 * @brief   Tests: fpgaGetProperties
 * @details When creating a properties object with a null properties argument<br>
 *          Then the result is FPGA_INVALID_PARAM<br>
 */
TEST( Properties, cliff_nodrv_prop_214)
{
    fpga_properties prop = NULL;
    fpga_result result = FPGA_OK;
