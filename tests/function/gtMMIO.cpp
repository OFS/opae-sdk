 ...
 *
 */
TEST(LibopaecMmioCommonHW, mmio_drv_positive_init_01) {
 ...
 *
 */
TEST(LibopaecMmioCommonHW, mmio_drv_positive_map_mmio_01) {
  struct _fpga_token _tok;
  fpga_token tok = &_tok;
  fpga_handle h = NULL;
  uint64_t* mmio_ptr = NULL;
 ...
 *
 */
TEST(LibopaecMmioCommonHW, mmio_drv_negative_map_mmio_02) {
  struct _fpga_token _tok;
  fpga_token tok = &_tok;
  fpga_handle h = NULL;
  uint64_t* mmio_ptr = NULL;
 ...
 *
 */
TEST(LibopaecMmioCommonHW, mmio_drv_positive_write_read_01) {
  struct _fpga_token _tok;
  fpga_token tok = &_tok;
  fpga_handle h = NULL;
  uint64_t* mmio_ptr = NULL;
 ...
 *
 */
TEST(LibopaecMmioCommonHW, mmio_drv_negative_write_read_01) {
  struct _fpga_token _tok;
  fpga_token tok = &_tok;
  fpga_handle h = NULL;
  uint64_t* mmio_ptr = NULL;
 ...
 *
 */
TEST(LibopaecMmioCommonHW, mmio_drv_positive_write32_read32_02) {
  struct _fpga_token _tok;
  fpga_token tok = &_tok;
  fpga_handle h = NULL;
  uint64_t* mmio_ptr = NULL;
 ...
 *
 */
TEST(LibopaecMmioCommonHW, mmio_drv_negative_write32_read32_02) {
  struct _fpga_token _tok;
  fpga_token tok = &_tok;
  fpga_handle h = NULL;
  uint64_t* mmio_ptr = NULL;
 ...
 *
 */
TEST(LibopaecMmioCommonHW, mmio_drv_negative_write_read_unmap_03) {
  struct _fpga_token _tok;
  fpga_token tok = &_tok;
  fpga_handle h = NULL;
  uint64_t value = 0;
 ...
 *
 */
TEST(LibopaecMmioCommonHW, mmio_drv_negative_write32_read32_unmap_04) {
  struct _fpga_token _tok;
  fpga_token tok = &_tok;
  fpga_handle h = NULL;
