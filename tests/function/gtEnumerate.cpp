 ...
 */
TEST_F(LibopaecEnumFCommonHW, 07) {
...
/**
 * @test       LibopaecEnumFCommonHW08
 *
 * @brief      fpgaEnumerate allows filtering by device guid.
 */
TEST_F(LibopaecEnumFCommonHW, 08) {
  fpga_guid guid;
 ...
 *             (FPGA_ACCELERATOR).
 */
TEST_F(LibopaecEnumFCommonHW, 16) {
  EXPECT_EQ(FPGA_OK,
            fpgaPropertiesSetObjectType(m_Properties, FPGA_ACCELERATOR));
...
/**
 * @test       LibopaecEnumFCommonHW17
 *
 * @brief      fpgaEnumerate allows filtering by number of slots
 *             (FPGA_DEVICE).
 */
TEST_F(LibopaecEnumFCommonHW, 17) {
  EXPECT_EQ(FPGA_OK, fpgaPropertiesSetObjectType(m_Properties, FPGA_DEVICE));
...
/**
 * @test       LibopaecEnumFCommonHW18
 *
 * @brief      fpgaEnumerate allows filtering by BBSID (FPGA_DEVICE).
 */
TEST_F(LibopaecEnumFCommonHW, 18) {
...
/**
 * @test       LibopaecEnumFCommonHW19
 *
 * @brief      fpgaEnumerate allows filtering by BBS Version
 *             (FPGA_DEVICE).
 */
TEST_F(LibopaecEnumFCommonHW, 19) {
 ...
 *
 */
TEST(LibopaecEnumCommonHW, enum_drv_020) {
  fpga_properties props;
  uint32_t nummatch;
  fpga_token clone;
  EXPECT_EQ(FPGA_OK, fpgaGetProperties(NULL, &props));
 ...
 *
 */
TEST_F(LibopaecEnumFCommonHW, DISABLED_enum_drv_021) {
  ...
  bool got_afu = strstr(((struct _fpga_token*)m_Matches[0])->sysfspath, "port");
 ...
 *
 */
TEST(LibopaecEnumCommonHW, enum_drv_022) {
  fpga_properties prop;
  fpga_guid guid;
  fpga_token tok;
