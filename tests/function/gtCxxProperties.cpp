 ...
 */
TEST(LibopaecppEnumCommonALL, set_guid) {
 ...
 */
TEST(LibopaecppEnumCommonALL, parse_guid) {
  fpga_guid guid_out;
  properties p;
  // set the guid to an fpga_guid
 ...
 * Then the known guid matches the one retrieved
 */
TEST(LibopaecppEnumCommonALL, get_guid) {
  fpga_guid guid_in;
  properties p;
 ...
 */
TEST(LibopaecppEnumCommonALL, compare_guid){
  fpga_guid guid_in;
  properties p;
  uuid_parse(TEST_GUID_STR, guid_in);
 ...
 * Then the result is true
 */
TEST(LibopaecppEnumCommonALL, props_ctor_01){
  fpga_guid guid_in;
  uuid_parse(TEST_GUID_STR, guid_in);
 ...
 */
TEST(LibopaecppEnumCommonALL, set_objtype) {
  properties p;
 ...
 */
TEST(LibopaecppEnumCommonALL, get_model) {
  properties p;
  std::string model = "";
