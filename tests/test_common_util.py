...
def test_get_filename():
    ...
    get_filename(get_filename_fullpath, get_filename_space)
...
def test_get_unit_size():
    ...
    get_unit_size(get_unit_size_size, get_unit_size_unit_size)
...
def test_get_password():
    get_password_messages = mock.MagicMock()
    get_password_MIN = mock.MagicMock()
    get_password_MAX = mock.MagicMock()
    get_password_comment = mock.MagicMock()
    get_password(get_password_messages, get_password_MIN, get_password_MAX, get_password_comment)

'''test_get_standard_hex_string'''

def test_get_standard_hex_string():
    init_size = mock.MagicMock()
    CHAR_POINTER_test = CHAR_POINTER(init_size)
    get_standard_hex_string_offset = mock.MagicMock()
    get_standard_hex_string_size = mock.MagicMock()
    CHAR_POINTER_test.get_standard_hex_string(get_standard_hex_string_offset, get_standard_hex_string_size)
...
def test_append_byte():
    init_type = mock.MagicMock()
    init_arg = mock.MagicMock()
    BYTE_ARRAY_test = BYTE_ARRAY(init_type, init_arg)
...
def test_assign_word():
    ...
    BYTE_ARRAY_test.assign_word(assign_word_offset, assign_word_word)
...
def test_assign_dword():
    ...
    BYTE_ARRAY_test.assign_dword(assign_dword_offset, assign_dword_dword)
...
def test_assign_qword():
    ...
    BYTE_ARRAY_test.assign_qword(assign_qword_offset, assign_qword_qword)
...
def test_assign_data():
    init_size = mock.MagicMock()
    CHAR_POINTER_test = CHAR_POINTER(init_size)
    assign_data_chars = mock.MagicMock()
    CHAR_POINTER_test.assign_data(assign_data_chars)
...
def test_get_word():
    ...
    BYTE_ARRAY_test.get_word(get_word_offset)
...
def test_get_dword():
    init_size = mock.MagicMock()
    CHAR_POINTER_test = CHAR_POINTER(init_size)
    get_dword_offset = mock.MagicMock()
    CHAR_POINTER_test.get_dword(get_dword_offset)
...
def test_get_qword():
    ...
    BYTE_ARRAY_test.get_qword(get_qword_offset)
...
def test_get_string():
    ...
    BYTE_ARRAY_test.get_string(get_string_offset, get_string_size)
...
def test_resize():
    ...
    BYTE_ARRAY_test.resize(resize_size)
...
def test_assign_partial_data():
    init_size = mock.MagicMock()
    CHAR_POINTER_test = CHAR_POINTER(init_size)
    assign_partial_data_chars = mock.MagicMock()
    assign_partial_data_source_offset = mock.MagicMock()
    assign_partial_data_dest_offset = mock.MagicMock()
    assign_partial_data_size = mock.MagicMock()
    CHAR_POINTER_test.assign_partial_data(assign_partial_data_chars, assign_partial_data_source_offset, assign_partial_data_dest_offset, assign_partial_data_size)
...
def test_compare_data():
    init_size = mock.MagicMock()
    CHAR_POINTER_test = CHAR_POINTER(init_size)
    compare_data_chars = mock.MagicMock()
    compare_data_error = mock.MagicMock()
    CHAR_POINTER_test.compare_data(compare_data_chars, compare_data_error)
