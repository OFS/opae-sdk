    ...
    def __init__(
        ...
        for key in self.SUPPORTED_TYPES:
            common_util.assert_in_error(
                ...
                (key, self.SUPPORTED_TYPES[key].MIN_CODE_SIGNING_KEY_ENTRIES,
            ...
            common_util.assert_in_error(
                ...
                ("File type (%s) maximum Code Signing Key entry (%d) " +
                 "cannot be more than family (%s) maximum " +
                 "Code Signing Key entry (%d)") %
                (key, self.SUPPORTED_TYPES[key].MAX_CODE_SIGNING_KEY_ENTRIES,
                 self.FAMILY, self.MAX_CODE_SIGNING_KEY_ENTRIES))
...
PUBKEY_R_BLOCK0 = 0x62fcaaf6
PUBKEY_R_BLOCK1 = 0x20857e51
PUBKEY_R_BLOCK2 = 0xb45c84bc
PUBKEY_R_BLOCK3 = 0x6a6c487e
PUBKEY_R_BLOCK4 = 0x99becd17
PUBKEY_R_BLOCK5 = 0x544998ca
PUBKEY_R_BLOCK6 = 0x71676310
PUBKEY_R_BLOCK7 = 0x647dd660

PUBKEY_S_BLOCK0 = 0x9bbacfa1
PUBKEY_S_BLOCK1 = 0x7d4774b2
PUBKEY_S_BLOCK2 = 0xd7396ba6
PUBKEY_S_BLOCK3 = 0x65c847d9
PUBKEY_S_BLOCK4 = 0xaff26de6
PUBKEY_S_BLOCK5 = 0x81d9b5b5
PUBKEY_S_BLOCK6 = 0x92394516
PUBKEY_S_BLOCK7 = 0x12a893f8
