...
if [ "git diff" != NULL ]; then
   echo "Coding style issues occured. Please fix them based on the following suggestions. You can run clang-format on these files in order to automatically format your code." 
   git --no-pager diff
