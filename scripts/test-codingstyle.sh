...
FILES=$(find ../libopae ../common/include/opae ../ase/api/src ../ase/sw ../tools/fpgaconf ../tools/fpgad ../samples \( -iname "*.c" -or -iname "*.h" \) -and \( ! -name "srv.c" \) -and \( ! -path "../libopae/src/usrclk/*" \) -and \( ! -path "../common/include/opae/cxx/*" \) -and \( ! -path "../samples/base/sw/*" \) )
